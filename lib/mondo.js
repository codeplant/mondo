...
//handlebar helpers
Mondo.handlebars.registerHelper('d', function(d) {
    return Mondo.date(d);
});

Mondo.handlebars.registerHelper('t', function(d) {
    return Mondo.time(d);
});

Mondo.handlebars.registerHelper('f', function(value, format) {
    return Mondo.format(value, format);
});

Mondo.handlebars.registerHelper('p', function(d) {
    return Mondo.percent(d);
});

Mondo.handlebars.registerHelper('c', function(value, format) {
    return Mondo.currency(value, format);
});
